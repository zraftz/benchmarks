...
impl Config {
    pub fn load() -> Result<Self> {
        ...
        {
            bail!("v1 requires voters 1,2,3, 20 ms ticks, capacity <= 65536, batch and inflight limits in 1..64, pipeline-only scheduling options, and one mixed-input policy");
        }
