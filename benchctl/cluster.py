...
class Cluster:
    def __init__(self, implementation: str, command: list[str], directory: Path,
                 data: Path, cluster_id: str, batch_size: int = 64, peer_batch_size: int = 1, diagnostics: bool = False, ordered_apply: bool = False, peer_message_stream: bool = False):
        ...
        try:
            ...
            for node in (1, 2, 3):
                ...
                write_json(self.configs[node], {"id": node, "cluster": cluster_id,
                    ...
                    "peer_batch_size": peer_batch_size, "diagnostics": diagnostics, "ordered_apply": ordered_apply, "peer_message_stream": peer_message_stream})
        finally:
