...
**Rafter pipeline completed 3.79× as many durable writes per second as the tested OpenRaft integration in the no-delay condition.**

| Added loopback egress | Rafter throughput | OpenRaft throughput | Advantage | Rafter p99 at 1,000/s | OpenRaft p99 at 1,000/s |
| ---: | ---: | ---: | ---: | ---: | ---: |
| 0 ms | **8,025 writes/s** | 2,116 writes/s | **3.79×** | **12.714 ms** | 18.088 ms |
| 2 ms | **4,689 writes/s** | 1,666 writes/s | **2.81×** | **20.972 ms** | 30.409 ms |

p99 at 100 writes/s — 0 ms: 5.308 ms vs 5.374 ms · 2 ms: 14.942 ms vs 16.384 ms

Rafter accounting: 0 errors · 0 unknown · 0 unsent
OpenRaft accounting: 0 errors · 0 unknown · 9 unsent

Pipeline versus same-code synchronous Rafter throughput — 0 ms: +1.5% · 2 ms: +3.0%
...
Evidence: [Detailed service results](https://github.com/zraftz/benchmarks/actions/runs/34609743659)
...
Evidence: [Detailed service results](https://github.com/zraftz/benchmarks/actions/runs/34609743659) · [Historical run 1](https://github.com/zraftz/benchmarks/actions/runs/34599945967)
