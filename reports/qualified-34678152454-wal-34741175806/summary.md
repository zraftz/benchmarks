...
| ---: | ---: | ---: | :---: | ---: | ---: |
| 10,000 entries | 980,188 bytes | 3 | passed | 7.396 ms | 2.633 ms |
| 100,000 entries | 9,800,188 bytes | 3 | passed | 26.544 ms | 22.471 ms |
...
Evidence: [Storage evidence](https://github.com/zsumz/rafter/actions/runs/34670447563) · [WAL reclamation evidence](https://github.com/zsumz/rafter/actions/runs/34741175806)
...
| Feature coverage | passed | completion-priority and bounded-lookahead activity were both observed |
...
**Finite recovery checks passed; WAL physical-reclamation component checks passed; comparative fault and sustained-operation performance remain unmeasured.**
...
- WAL physical-reclamation component: 2 cases passed — 10k and 100k retained suffixes across repeated writes, snapshots, compaction, physical cleanup, and exact reopen; not complete-service traffic or latency evidence
...
Not yet measured: comparative leader-loss performance; comparative slow-follower performance; storage-stall recovery performance; complete-service snapshot/compaction and WAL-reclamation soak performance.

Evidence: [Detailed service results](https://github.com/zraftz/benchmarks/actions/runs/34678152454) · [Historical run 1](https://github.com/zraftz/benchmarks/actions/runs/34599945967) · [Historical run 2](https://github.com/zraftz/benchmarks/actions/runs/34673142049) · [WAL reclamation evidence](https://github.com/zsumz/rafter/actions/runs/34741175806)
